...
public class UserController{
	...
	public UserController(UserService userService, MessageService _ms, EventService _es){
	...
	@PostMapping("/events")
	public String newEvent(HttpSession s, @Valid @ModelAttribute("event") Event event, BindingResult res){
		if(res.hasErrors()){
			return "dashboard";
		}
		User host = userService.findById((Long)s.getAttribute("id"));
